...
/**
 * Class RectificacionController

 * @Route("/api/v1/extraccion/rectificacion")
 */
class RectificacionController extends FOSRestController
{
     ...
     * )
     *
     * @SWG\Tag(name="Extraccion")
     * @param SerializerInterface $serializer
     * @param EntityManagerInterface $em
     * @return Response
     */
    public function getRectificacionAction(SerializerInterface $serializer, EntityManagerInterface $em) {
     ...
     * @return Response
     */
    public function postRectificacionAction (SerializerInterface $serializer, EntityManagerInterface $em, Request $request) {
     ...
     * @return Response
     */
    public function putRectificacionAction (LoggerInterface $logger, SerializerInterface $serializer, EntityManagerInterface $em, Request $request, $id) {
