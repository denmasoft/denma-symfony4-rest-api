 ...
 * @Route("/api/v1/extraccion")
 */
class ExtraccionController extends FOSRestController
{
     ...
     * @return Response
     */
    public function getExtraccionAction(SerializerInterface $serializer, EntityManagerInterface $em) {
     ...
     * @return Response
     */
    public function postExtraccionAction (SerializerInterface $serializer, EntityManagerInterface $em, Request $request) {
     ...
     * @return Response
     */
    public function putExtraccionAction (LoggerInterface $logger, SerializerInterface $serializer, EntityManagerInterface $em, Request $request, $id) {
