...
/**
 * Class DestruccionController

 * @Route("/api/v1/extraccion/destruccion")
 */
class DestruccionController extends FOSRestController
{
     ...
     * )
     *
     * @SWG\Tag(name="Destruccion")
     * @param SerializerInterface $serializer
     * @param EntityManagerInterface $em
     * @return Response
     */
    public function getDestruccionAction(SerializerInterface $serializer, EntityManagerInterface $em) {
     ...
     * @return Response
     */
    public function postDestruccionAction (SerializerInterface $serializer, EntityManagerInterface $em, Request $request) {
     ...
     * @return Response
     */
    public function putDestruccionAction (LoggerInterface $logger, SerializerInterface $serializer, EntityManagerInterface $em, Request $request, $id) {
