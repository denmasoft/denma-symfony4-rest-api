 ...
 * @Route("/api/v1/extraccion/traspaso")
 */
class TraspasoController extends FOSRestController
{
     ...
     * )
     *
     * @SWG\Tag(name="Traspaso")
     * @param SerializerInterface $serializer
     * @param EntityManagerInterface $em
     * @return Response
     */
    public function getTraspasoAction(SerializerInterface $serializer, EntityManagerInterface $em) {
     ...
     * @return Response
     */
    public function postTraspasoAction (SerializerInterface $serializer, EntityManagerInterface $em, Request $request) {
     ...
     * @return Response
     */
    public function putTraspasoAction (LoggerInterface $logger, SerializerInterface $serializer, EntityManagerInterface $em, Request $request, $id) {
