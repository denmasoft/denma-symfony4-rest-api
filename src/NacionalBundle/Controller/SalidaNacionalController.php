...
namespace App\NacionalBundle\Controller;
...
/**
 * Class SalidaNacionalController

 * @Route("/api/v1/nacional/salida")
 */
class SalidaNacionalController extends FOSRestController
{
     ...
     * )
     *
     * @SWG\Tag(name="SalidaNacional")
     * @param SerializerInterface $serializer
     * @param EntityManagerInterface $em
     * @return Response
     */
    public function getSalidaNacionalAction(SerializerInterface $serializer, EntityManagerInterface $em) {
     ...
     * @return Response
     */
    public function postSalidaNacionalAction (SerializerInterface $serializer, EntityManagerInterface $em, Request $request) {
     ...
     * @return Response
     */
    public function putSalidaNacionalAction (LoggerInterface $logger, SerializerInterface $serializer, EntityManagerInterface $em, Request $request, $id) {
